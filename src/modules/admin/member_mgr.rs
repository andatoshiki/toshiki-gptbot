...
impl MemberManager {
    ...
    pub async fn adduser(&self, username: String) -> Result<bool, Error> {
    ...
    pub async fn deluser(&self, username: String) -> Result<bool, Error> {
        let result = self
            .db_mgr
            .query(move |conn| {
    ...
    pub async fn public_usable(&self, public_usable: bool) -> Result<(), Error> {
        self.pref_mgr
